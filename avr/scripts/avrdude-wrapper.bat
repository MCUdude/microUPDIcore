...
"%avrdudePath%" "-C%configPath%" -v -p%buildMCU% -c%uploadProtocol% "-P%serialPort%" -b%uploadSpeed% -D "-Ueeprom:w:%runtimePlatformPath%/firmwares/mEDBG_UPDI_1.13_modified_suffer.eep:i" "-Uflash:w:%runtimePlatformPath%/firmwares/mEDBG_UPDI_1.13_no_bootloader.hex:i"> "%buildPath%/avrdudeoutput.txt" 2>&1
